...
namespace Resolver.DNS
{
    ...
    public class Resolver
    {
        ...
        {
            // adding default dns servers also
            var lsDns = new List<IPEndPoint>(DefaultDnsServers);
            lsDns.AddRange(DnsServers);

            DnsServers = lsDns.ToArray();
        ...
        #endregion Deprecated methods in the original System.Net.DNS class
